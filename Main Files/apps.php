                                    ...
                                    <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-15p border-bottom-0">Manage Server App</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <?php
if(mysqli_num_rows($query_run) > 0){
    ...
    ?>
        ...
        ?>
                                                        ...
                                                        <?php 
        if (!$status) {
            echo "<button type='button' class='btn btn-primary mb-4' disabled>Manage Apps</button>";
        } else {
            echo "<form action='manage-apps.php' method='post'><input type='hidden' name='utilityserver_id' value='" . $row['server_id'] . "'><button type ='submit' name='utility-serverbtn' class='btn btn-primary mb-4'>Manage Apps</button></form>";
        }
        ?>
                                                            </td>
                                                    </tr>
