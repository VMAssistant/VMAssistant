        ...
        ?>
                            ...
                            <form action="functions.php" method="POST">
                                    ...
                                    <div class="card-footer text-end">
                                        ...
                                        <button type="submit" name="update_adminbtn" class="btn btn-success my-1">Save</button>
                             </form>
                                        <?php
    }
}
...
if(isset($_POST['editbtn'])){
    ...
    foreach($query_run as $row){
        ?>
                                    ...
                                    <div class="card-footer text-end">
                                        <button type="submit" name="update_adminpassbtn" class="btn btn-primary">Update</button>
                                    </form>
                                    <?php
    }
}
