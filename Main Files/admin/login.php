...
<head>
    ...
    <meta name="description" content="VM Assistant - Admin Login">
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="../assets/images/brand/favicon.ico" />

    <!-- TITLE -->
    <title>VM Assistant - Admin Login</title>
                                ...
                                <div class="panel-body tabs-menu-body p-0 pt-5">
                                    <div class="tab-content">
                                            ...
                                            <div class="container-login100-form-btn">
                                                <button type="submit" name="loginbtn" class="login100-form-btn btn-primary">Login</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
