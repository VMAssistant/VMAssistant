            ...
            <div class="row row-sm">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <button type="button" id="table2-new-row-button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#adduser"> Add New User</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    ...
                    <button class="btn ripple btn-success" name="adduserbtn" type="submit">Add</button>
    ...
    <!-- End Input modal -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-footer">
                    <button type="submit" name="deletebtn" class="btn ripple btn-success">Delete</button>
                    <button class="btn ripple btn-danger" data-bs-dismiss="modal" type="button">Close</button>
